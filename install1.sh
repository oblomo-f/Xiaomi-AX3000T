...
echo "isWorkZapret = $isWorkZapret, isWorkOperaProxy = $isWorkOperaProxy"

if [ "$isWorkZapret" = "1" ] && [ "$isWorkOperaProxy" = "1" ] 
then
	varByPass=1
elif [ "$isWorkZapret" = "0" ] && [ "$isWorkOperaProxy" = "1" ] 
then
	varByPass=4
elif [ "$isWorkZapret" = "1" ] && [ "$isWorkOperaProxy" = "0" ]
then
	varByPass=5
elif [ "$isWorkZapret" = "0" ] && [ "$isWorkOperaProxy" = "0" ] 
then
	varByPass=8
fi
